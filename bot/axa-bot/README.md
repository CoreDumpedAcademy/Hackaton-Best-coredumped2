...
- Navigate to `axa-bot` folder
- Select `axa-bot.bot` file
...
msbot clone services --name "axa-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
